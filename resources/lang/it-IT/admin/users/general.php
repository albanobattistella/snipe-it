...
return [
    ...
    'ldap_sync_intro'   => 'Fai clic sul pulsante qui sotto per sincronizzare manualmente i tuoi utenti LDAP. Per ulteriori informazioni sulla configurazione della sincronizzazione LDAP per l'esecuzione automatica, consulta la <a href=":link" target="_blank">documentazione <i class="fa fa-external-link"></i></a>.',
