...
return [
    ...
    'snipe_version'  			=> 'Versione di Snipe-IT',
    ...
    'labels_title_help' => 'Le modifiche apportate qui devono essere salvate prima di essere riflesse nelle etichette o nell'anteprima sottostante.',
    ...
    'label2_2d_prefix'        => 'Prefisso del codice a barre 2D',
    'label2_2d_prefix_help'   => 'Questo testo verrà anteposto al valore di destinazione del codice a barre 2D selezionato di seguito durante la scansione del codice 2D. Può essere utilizzato per anteporre un URL esterno o qualsiasi altro valore necessario.',
    'label2_2d_target'        => 'Contenuto del codice a barre 2D',
    'label2_2d_target_help'   => 'I dati che saranno contenuti nel codice a barre 2D. Possono essere collegati direttamente alla risorsa in Snipe-IT oppure possono essere uno dei valori di campo non collegati. Se si utilizza il prefisso sopra, verrà anteposto a questo valore.',
    'select_template'         => 'Seleziona un modello',
    'label2_fields'           => 'Definizioni Campi',
    'label2_fields_help'      => 'I campi possono essere aggiunti, rimossi e riordinati nella colonna di sinistra. Per ogni campo, è possibile aggiungere, rimuovere e riordinare più opzioni per Etichetta e Origine Dati nella colonna di destra. Le modifiche apportate ai campi qui verranno immediatamente riportate nell'anteprima sottostante, ma devono essere salvate per poter essere applicate alle nuove etichette.',
    ...
    'help_default_will_use' => 'Si noti che il valore dei codici a barre deve essere conforme alle specifiche del codice a barre per poter essere generato correttamente. Per maggiori dettagli, consultare la <a href="https://snipe-it.readme.io/docs/barcodes">documentazione <i class="fa fa-external-link"></i></a>. ',
    'asset_id'              => 'ID Bene',
    'data'               => 'Dati',
    'default'               => 'Predefinito',
    'none'                  => 'Niente',
    ...
    'email_formats' => [
        ...
        'last_name_format'		=> 'Cognome (smith@example.com)',
